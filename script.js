...
cards.forEach((card, index) => {
    ...
    if (newPosition < 5) {
        card.className = 'card ' + positions[newPosition];
        card.style.transition = 'transform 0.09s cubic-bezier(0.25, 0.46, 0.45, 0.94)'; // Smooth easing
...
}, 600); // Adjusted to match new timing
}
